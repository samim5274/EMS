                        ...
                        <?php if(isset($_GET['error'])){ ?> <p class="error"><?php echo $_GET['error']; ?></p> <?php } ?>
                            ...
                            <form action="login.php" method="post" class="p-3 mt-3">
                                <div class="form-field d-flex align-items-center">
                                    ...
                                    <input type="text" name="email" id="userName" placeholder="Emain address">
                                </div>
                                <div class="form-field d-flex align-items-center">
                            ...
                            <div class="text-center fs-6">
                                <!-- <a href="#">Forget password?</a> or <a href="#" onclick="btnOpenSingin()">Sign up</a> -->
                                <p><a href="#"> Forget password </a> or <a href="#" onclick="btnOpenSingup()">Sing up</a> </p>
                            </div>
                        </div>
                    </div>
                </div>
