...
<section>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="img/1.1.jpg" alt="Los Angeles" class="d-block" style="width:100%">
        ...
        <div class="carousel-item">
            <img src="img/1.3.jpg" alt="Chicago" class="d-block" style="width:100%">
            <div class="carousel-caption">
                <h3 class="display-4">Los Angeles</h3>
                <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
            </div>
        ...
        <div class="carousel-item">
            <img src="img/1.2.jpg" alt="New York" class="d-block" style="width:100%">
            <div class="carousel-caption">
                <h3 class="display-4">Los Angeles</h3>
                <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
            </div>
